    ...
    return Column(
      ...
      children: [
        ...
        StreamBuilder<String>(
            stream: viewModel.formStepSelectPix.contato,
            builder: (context, contatoData) {
              contatoTransferenciaControll.value = contatoTransferenciaControll
                  .value
              ...
              return ListTile(
                title: TextFormField(
                  ...
                  onChanged: (value) {
                    viewModel.formStepSelectPix.onContatoChange(value);
                  },
                ),
                trailing: IconButton(
                  onPressed: () async {
                    ...
                    if (result != null) {
                      setState(() {
                        ...
                        viewModel.formStepSelectPix
                            .onPixSelectChange(jsonEncode(result));
                      });
                    }
                  },
        ...
        Container(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (ctx, index) => StreamBuilder<String>(
                stream: viewModel.formStepSelectPix.pixSelect,
                builder: (context, pixSelectData) {
                  return ListTile(
                    ...
                    title: Text(
                        'Contato: ${widget.pixToSendList[index].holderName}'),
                    subtitle: Text(widget.pixToSendList[index].pspName),
                    onTap: () {
                      if (pixSelectData.data != null) {
                        ...
                        if (widget.pixToSendList[index].id == pix.id) {
                          viewModel.formStepSelectPix.onPixSelectChange('');
                        } else {
                          viewModel.formStepSelectPix.onPixSelectChange(
