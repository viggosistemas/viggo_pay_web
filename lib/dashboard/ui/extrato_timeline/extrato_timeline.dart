        ...
        return listExtrato.isEmpty
            ...
            : Container(
                ...
                child: ListView.builder(
                  itemCount: lengthExtrato <= listExtrato.length ? lengthExtrato : listExtrato.length,
                      ...
                      trailing: Column(
                        ...
                        children: [
                          Text(
                            ...
                            style: GoogleFonts.lato(
                              color: listExtrato[index].type == 'D' ? Colors.red : Colors.green,
                              fontSize: 18,
                              fontWeight: FontWeight.bold,
                            ),
                          ),
                          Text(
                            DateFormat('dd/MM/yyyy').format(DateTime.parse(listExtrato[index].creditDate)),
                            style: GoogleFonts.lato(
                              fontSize: 14,
                              color: Theme.of(context).brightness == Brightness.dark ? Colors.black.withOpacity(0.7) : Colors.white.withOpacity(0.7),
                            ),
                          ),
                        ],
                      ),
